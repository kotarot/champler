...
<html lang="ja" class="no-js" prefix="og: http://ogp.me/ns#"><!--<![endif]-->
  <head>
    ...
    <title>Champler! 3x3x3 スクランブルジェネレータ &hearts; {{ param.sitename }}</title>
    <!-- Modernizr -->
    ...
    <meta property="og:url" content="{{ param.baseurl }}/champler">
    <meta property="og:image" content="{{ param.baseurl }}/champler.png">
  </head>
  <body>
